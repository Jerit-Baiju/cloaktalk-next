...
export default function ChatComponent() {
  ...
  if (!currentChat) {
    ...
    const desc = deadChat
      ? 'The other participant has left or the chat has ended.'
      ...
      <div className="flex items-center justify-center min-h-screen bg-neutral-950 text-neutral-200">
        <div className="max-w-md mx-auto bg-neutral-900 border border-neutral-800 rounded-xl p-6 text-center">
          {!deadChat ? (
            ...
            <div className="w-12 h-12 mx-auto mb-4 bg-red-500/15 text-red-300 rounded-full flex items-center justify-center">!
            </div>
          )}
