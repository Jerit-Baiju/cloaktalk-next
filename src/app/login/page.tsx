        ...
        <div className='bg-white rounded-2xl shadow-xl p-8 sm:p-10 relative z-10'>
          ...
          <div className='space-y-6'>
            <button
              ...
              className='group relative w-full px-6 py-4 bg-gradient-to-r from-pink-500 to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-600'>
                    We use your college Google account to verify you're part of the campus community and ensure a safe environment for all students.
                  </p>
                </div>
              </div>
            </div>
